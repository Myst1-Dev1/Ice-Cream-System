        ...
        <>
            <div className={`px-3 py-8 transition-all duration-500 ${dark ? 'bg-[#202020] text-white' : 'bg-[#fbfbfb] text-black'}`}>
                ...
                <div className="py-12 mb-8">
                    ...
                    {data?.filter((sales: SalesType) => sales.type === "venda").map((sales: SalesType) => (
                            ...
                            <table className="w-full table-fixed">
                                <thead>
                                    <tr className="text-left border-b border-gray-300">
                                        ...
                                        {sales.amount && <th className="py-2 pr-3 w-1/3 text-sm font-medium text-gray-500 text-right">Quantidade</th>}
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr className="text-left">
                                        ...
                                        {sales.amount && <td className="py-2 pr-3 w-1/3 text-base font-normal text-right">{sales.amount}</td>}
                                    </tr>
                                </tbody>
                            </table>
                        </div>
